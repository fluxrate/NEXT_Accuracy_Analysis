...
class LSTMAutoEncoder(ModelWrapper):
    # TODO why are the __init__ parameters saved twice?
    def __init__(self,
                 Name,
                 InputShape=(10, 100),
                 Widths=[10],
    ...
    def Build(self):
        ...
        for i in range(0, len(self.Widths)):
            ...
            myModel = LSTM(self.Widths[i], consume_less="gpu", unroll=True,
        ...
        myModel = LSTM(self.InputShape[1], consume_less="gpu", unroll=True, return_sequences=True)(myModel)
